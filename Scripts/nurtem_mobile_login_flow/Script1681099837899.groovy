...
String testCaseName = 'Tutor Login Report'
...
for (def row : data)
	{
		...
		Mobile.callTestCase(findTestCase('Test Cases/nurtem_tutor'), [('testCaseName') : testCaseName, ('testCaseData') : row],
		FailureHandling.CONTINUE_ON_FAILURE)
	}
WebUtil.mobile_generateReport(testCaseName, filterBy)