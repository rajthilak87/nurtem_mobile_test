...
import static com.kms.katalon.core.mobile.keyword.MobileBuiltInKeywords.takeScreenshot
...
public class Util {
	...
	def static void getMobileObj(Mobile mobile) {
		this.mobile = Mobile
	}
	/**
	 * Get AbsoluteUrl
	...
	/*
	 * Generater Mobile App report
	 */
	def static void mobile_generateReport(String tcName, def filterBy) {
	...
	def static void deleteFile()
	{
		try
		{
			File f= new File(GlobalVariable.projectRootPath + "\\snapshots\\" + 'snap.png');           //file to be delete
	...
	//		def static void readToastMsg(String tcName='', Map data = [:], String msg='',boolean reportErr=false)
	//		{
	...
	//				Util.mobile_reportAndtakeScreenshot(tcName, data, 'The password is incorrect :', true)
	//			}else if (result.contains('Sign up'))
	//			{
	//				Util.mobile_reportAndtakeScreenshot(tcName, data, 'Please signup first : ', true)
	//			}else if (result.contains('*\nvaHd'))
	//			{
	//				Util.mobile_reportAndtakeScreenshot(tcName, data, 'Invalid Email or Password : ', true)
	//			}else  if (result.contains('= nurtem'))
	//			{
	//				Util.mobile_reportAndtakeScreenshot(tcName, data, 'Login Successful : ', false)
	//			}
	//			Mobile.delay(2)
	//		}
...
//		Mobile.takeScreenshot(pathToScreenshots, FailureHandling.CONTINUE_ON_FAILURE)
	...
	def static void mobile_reportAndtakeScreenshot(String tcName='', Map data = [:], String msg='',boolean reportErr=false) {
